...
%Put in the correct values for Sampling rate, measurement noise and
%ratio between measurement and model variance

function [output_args] = kalman_gain_roll_gyro_21 (sampling_rate , measurement_noise , variance_ratio);
  ...
  Q = [0 0;0 model_variance];  %model noise covariace matrix
